                       ...
                       int size, int groupsize, %(type)s L)
{
    ...
    func.prepare('PPPii'+np.dtype(dtype).char)
    return func
...
sq_Kernel(%(types)s* d_S, %(typeq)s* d_q, %(types)s rcond, int size)
{
    ...
    func.prepare('PP'+np.dtype(dtype_s).char+'i')
    return func
...
sinv_Kernel(%(types)s* d_S, %(types)s rcond, int size)
{
    ...
    func.prepare('P'+np.dtype(dtype_s).char+'i')
    return func
             ...
             int size, %(types)s rcond)
{
    ...
    func.prepare('PPii'+np.dtype(dtype_s).char)
    return func
